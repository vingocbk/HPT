...
void ControlLedColor(){
    ...
    if (rootData.success()) {
        ...
        analogWrite(PIN_LED_RED, uint8_t(red_after));
        analogWrite(PIN_LED_GREEN, uint8_t(green_after));
        analogWrite(PIN_LED_BLUE, uint8_t(blue_after));
...
//        ECHOLN("LED IS ON!");
//        flag_led = true;
        analogWrite(PIN_LED_RED, uint8_t((float)red_before*intensityLight/100));
        analogWrite(PIN_LED_GREEN, uint8_t((float)green_before*intensityLight/100));
        analogWrite(PIN_LED_BLUE, uint8_t((float)blue_before*intensityLight/100));
//    }
