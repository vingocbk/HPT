...
#define TIME_READ_NOT_REGISTER 500
...
void ConfigModeWifi();                  //nhan data tu app
void ConfigModeTemperature();                  //nhan data tu app
void configResetRegister();                  //nhan data tu app
void setLedApMode();                //hieu ung led
void setBuzzer();                //hieu ung led
String GetFullSSID();
...
Ticker tickerBuzzer(setBuzzer, 100, 0);   //every 200ms
